describe('bazel_bash_completion_request.get_completion_request', function()
  it('builds a completion request (case: cursor at the end)', function()
    ...
    local bazel_bash_completion_request =
      require('pesto.cli.bazel_bash_completion.bazel_bash_completion_request')
    local request = bazel_bash_completion_request.get_bazel_bash_completion_request(
      subcommand_complete_opts,
      bash_tokens
    )
